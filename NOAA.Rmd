...
populationHealthData <- melt(merge(fatalityCount, injuryCount, by= "eventClassification"), id.vars=c("eventClassification"))
...
economicHealthData <-melt(merge(propertyDamageAmount, cropDamageAmount, by= "eventClassification"), id.vars=c("eventClassification"))
```

## Results
```{r Results, fig.width=12}
