...
# List of valid states, according to ANSI
...
totalCropDamageByState <- totalCropDamageByState[totalCropDamageByState$STATE %in% validStates,]

totalPropDamageByState <- aggregate(realPropDamage~STATE, data=originalData, FUN=sum)
totalPropDamageByState <- totalPropDamageByState[totalPropDamageByState$STATE %in% validStates,]
